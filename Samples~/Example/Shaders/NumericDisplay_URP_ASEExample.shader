...
Shader "DebugShaderPack/NumericDisplay_URP_ASEExample"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_pixelSize( "pixelSize", Vector ) = ( 12, 24, 0, 0 )
		_pixelOffset( "pixelOffset", Vector ) = ( 0, 0, 0, 0 )
		_rinfo( "rinfo", Float ) = 0
		_ginfo( "ginfo", Float ) = 0
		_binfo( "binfo", Float ) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color33 = IsGammaSpace() ? float4( 0.754717, 0.754717, 0.754717, 1 ) : float4( 0.5299, 0.5299, 0.5299, 1 );
				float2 screenUV4_g2 = ScreenPosNorm.xy;
				float3 objToWorld13_g2 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float3 worldPosition11_g2 = objToWorld13_g2;
				float4 localDSP_GetWorldClipPosition11_g2 = DSP_GetWorldClipPosition( worldPosition11_g2 );
				float4 objectOriginClipPos4_g2 = localDSP_GetWorldClipPosition11_g2;
				float rInfo4_g2 = _rinfo;
				float gInfo4_g2 = _ginfo;
				float bInfo4_g2 = _binfo;
				float2 pixelOffset4_g2 = _pixelOffset;
				float2 pixelSize4_g2 = _pixelSize;
				float4 localDSP_RenderDebugOverlayScreenUV4_g2 = DSP_RenderDebugOverlayScreenUV( screenUV4_g2 , objectOriginClipPos4_g2 , rInfo4_g2 , gInfo4_g2 , bInfo4_g2 , pixelOffset4_g2 , pixelSize4_g2 );
				float4 lerpResult10_g2 = lerp( float4( color33.rgb , 0.0 ) , localDSP_RenderDebugOverlayScreenUV4_g2 , localDSP_RenderDebugOverlayScreenUV4_g2.w);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult10_g2.xyz;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-576,-160;Inherit;False;Property;_pixelOffset;pixelOffset;1;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-592,-32;Inherit;False;Property;_pixelSize;pixelSize;0;0;Create;True;0;0;0;False;0;False;12,24;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-544,144;Inherit;False;Property;_rinfo;rinfo;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;29;-544,224;Inherit;False;Property;_ginfo;ginfo;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;30;-528,304;Inherit;False;Property;_binfo;binfo;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;32;-160,-128;Inherit;False;NumericDisplay;-1;;2;eb88107bfd9c4fd43a2f48cd05c24338;0;7;19;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;17;FLOAT2;0,0;False;18;FLOAT2;16,24;False;14;FLOAT;0;False;15;FLOAT;0;False;16;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-544,-400;Inherit;False;Constant;_BackColor;BackColor;5;0;Create;True;0;0;0;False;0;False;0.754717,0.754717,0.754717,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1;320,-112;Float;False;True;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;12;DebugShaderPack/NumericDisplay_URP_ASEExample;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;10;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;27;Surface;0;0;  Keep Alpha;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Forward Only;0;0;Cast Shadows;1;0;Receive Shadows;2;0;Receive SSAO;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;False;0
...
WireConnection;32;19;33;5
WireConnection;32;17;13;0
WireConnection;32;18;12;0
WireConnection;32;14;20;0
WireConnection;32;15;29;0
WireConnection;32;16;30;0
WireConnection;1;2;32;0
ASEEND*/
//CHKSM=DC9510E33599A1DC365EB130E8534C10FF4511AB